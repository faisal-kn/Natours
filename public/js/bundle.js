      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'error logging out try out!!!');
...
var displayMap = function displayMap(locations) {
  console.log(2);
  mapboxgl.accessToken = 'pk.eyJ1IjoiZmFpc2FsLWtuIiwiYSI6ImNrcjB0Z2NuZTF2M2UzMXFwb20xN2MxYmcifQ.6URv3dW1IFSDsuDJj0tLiQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/faisal-kn/ckr0tznue03pq17qoqacqirof' //   center: [-116.504146, 35.845208],
    //   zoom: 4,
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>".concat(loc.description, "<p>")).addTo(map); //extend map-bound to include the current location
...
var updatePassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(passwordCurrent, password, confirmPassword) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51JDvf6SAPK2Nlfh218NBVfP3JY56cs3tce6L6A9agvjfenk47pVB8AjxRJMoMrO10qbXpNB8q4ccKKPJNRommlSX00FTaTBq12');
            _context.next = 3;
            return (0, _axios.default)("http://127.0.0.1:3000/api/v1/bookings/checkout-session/".concat(tourId));

          case 3:
            session = _context.sent;
            console.log(session); //Create a checkout form to charge the credit card
